...
def test_upload_download():
    ...
    # upload a file
    Upload.upload_file(
        filename_to_gcp='test',
        encoded_zipfile_string=upload_str,
        destination_bucket_gcp=BUCKET
    )

    print("uploaded")

    # download the data
    data = Download.download_text(filename_to_gcp='test.txt', destination_bucket_gcp=BUCKET)
